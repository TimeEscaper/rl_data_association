...
def plot_obs_landmarks(detected_landmarks):
    """
    Plot landmarks on the field

    :param detected_landmarks: landmarkposition in global frame
    """

    center = [detected_landmarks[0], detected_landmarks[1]]
    plt.show()

    plt.plot(center[0], center[1], color='green', marker='o')
